...
6. `[todo]` 手機版歷史新聞 drawer（**今日最高優先，已 pending 約 99 天**）
...
7. `[todo]` Cron 健康檢查
   - 對 production 執行 `?dryRun=1`，確認 `candidates` 數量合理。（**9/24–9/25 已驗**：HTTP 200，JSON 含 `candidates: 15`、`hermesLegacyCandidates: 10`、`usedAi: false`。）
